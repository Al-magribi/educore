...
export const pageStyle = {
  ...
  borderRadius: 16,
  background:
    "radial-gradient(circle at top left, rgba(34, 197, 94, 0.12), transparent 24%), linear-gradient(180deg, #f8fafc 0%, #effdf6 100%)",
};
...
export const transactionTypeLabel = (value) => {
  if (value === "income") {
    return "Pemasukan";
  }
