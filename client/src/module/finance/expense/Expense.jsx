    ...
    <Card
      ...
      <Tabs
        ...
        items={[
          {
            key: 'kategori',
            label: createTabLabel('Kategori', <Tags size={isMobile ? 14 : 16} />, 'Master untuk RAPBS'),
            children: <ExpenseCategoryTab />,
          },
          {
            key: 'harian',
            label: createTabLabel('Harian', <CalendarDays size={isMobile ? 14 : 16} />, 'Pengeluaran operasional'),
            children: <ExpenseDailyTab />,
          },
          {
            key: 'honorarium',
            label: createTabLabel('Honorarium', <WalletCards size={isMobile ? 14 : 16} />, 'Pembayaran honor'),
