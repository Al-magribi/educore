...
const StudentDash = () => {
  ...
  if (isError) {
    return (
      <AppLayout title="Dashboard">
        <div style={styles.error}>Gagal memuat data dashboard siswa.</div>
      </AppLayout>
    );
  }
          ...
          <div style={styles.card}>
            ...
            <div style={{ marginTop: 14, display: "grid", gap: 10 }}>
              <div style={styles.listItem}>
                ...
                <span style={{ fontWeight: 600 }}>{data?.student?.nis || "-"}</span>
              </div>
              <div style={styles.listItem}>
                <span style={styles.statLabel}>NISN</span>
                <span style={{ fontWeight: 600 }}>{data?.student?.nisn || "-"}</span>
              </div>
              <div style={styles.listItem}>
