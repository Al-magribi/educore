-- Seed data untuk fitur presensi RFID
-- Jalankan setelah:
...
WHERE da.attendance_date >= CURRENT_DATE - INTERVAL '35 days'
  AND NOT EXISTS (
      SELECT 1
...
WITH schedule_source AS (
    ...
    WHERE da.target_role = 'teacher'
      ...
      AND da.attendance_date >= CURRENT_DATE - INTERVAL '35 days'
)
