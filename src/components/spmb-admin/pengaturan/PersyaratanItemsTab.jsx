...
function FeeItemForm({ periods, initial, onSave, onCancel, saving }) {
    ...
    <form onSubmit={handleSubmit} className="space-y-5 rounded-2xl border border-slate-200 bg-white p-5">
      <div>
        <h3 className="text-lg font-semibold text-slate-900">
          {initial ? "Edit item persyaratan" : "Tambah item persyaratan"}
        </h3>
      ...
      <section className="overflow-hidden rounded-xl border border-slate-200">
        <div className="border-b border-slate-100 px-4 py-3">
          ...
          <p className="mt-1 text-xs text-slate-500">Nominal dapat berbeda untuk setiap gelombang.</p>
        </div>
